...
if (!passwordProvided) {
    return `AUTH_REQUIRED:su:${targetName}`;
        ...
        console.log("🔍 COMANDO SU: Juicio final de hashes:", {
    usuarioBuscado: targetName,
    passwordEnBrutoPasada: passwordProvided,
    hashCalculadoAhora: inputHash,
    hashAlmacenadoEnDB: user.password
});
