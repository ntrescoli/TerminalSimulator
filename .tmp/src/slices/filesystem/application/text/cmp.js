...
exports.Cmp = void 0;
const PathResolver_1 = require("../../../filesystem/application/services/PathResolver");
exports.Cmp = {
    name: 'cmp',
    valuedFlags: [],
    execute: async ({ args, fs }) => {
        ...
        const node1 = PathResolver_1.PathResolver.resolve(path1, currentDir, rootNode);
        if (!node1 || node1.type !== 'file') {
            return `cmp: ${path1}: No such file or directory`;
        }
        // 3. Resolver y leer el segundo archivo
        const node2 = PathResolver_1.PathResolver.resolve(path2, currentDir, rootNode);
